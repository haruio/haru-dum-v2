...
var _user$project$Players_Messages$SaveFail = function (a) {
	return {ctor: 'SaveFail', _0: a};
};
var _user$project$Players_Messages$SaveSuccess = function (a) {
...
var _user$project$Players_Messages$FetchAllFail = function (a) {
	return {ctor: 'FetchAllFail', _0: a};
};
var _user$project$Players_Messages$FetchAllDone = function (a) {
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_user$project$Players_List$editBtn(player)
					]))
			]));
};
var _user$project$Players_List$list = function (players) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('p2')
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
...
var _user$project$Players_List$nav = function (players) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('clearfix mb2 white bg-black')
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('left p2')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
...
var _user$project$Players_List$view = function (players) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_user$project$Players_List$nav(players),
				_user$project$Players_List$list(players)
			]));
};
